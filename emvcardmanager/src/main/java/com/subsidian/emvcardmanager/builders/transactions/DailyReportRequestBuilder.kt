...
object DailyReportRequestBuilder {
    ...
    fun build (isoData: ISOData, messageFactory: MessageFactory<IsoMessage>, terminalSessionKey: String = ""): ISOMessage {
        ...
        val managementDataTwo = StringBuilder().append("01")
        /** Set ProcCode **/
        ...
        /** Set Management Data Two **/
        if (isoData.managementDataTwoPrivate != null && !StringUtil.isEmpty(isoData.managementDataTwoPrivate)) {
            message.setValue(
                63,
                isoData.managementDataTwoPrivate,
                templ.getField<Any>(63).type,
                isoData.managementDataTwoPrivate!!.length)
        } else {
            message.setValue(
                63,
                managementDataTwo.toString(),
                templ.getField<Any>(63).type,
                managementDataTwo.toString().length)
        }
